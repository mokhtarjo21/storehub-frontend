...
const translations = {
  en: {
    ...
    'home.hero.subtitle': 'Discover cutting-edge network devices, software licenses, and professional installation services',
    ...
    'home.features.licenses.desc': 'Genuine software licenses with instant delivery',
    ...
    'auth.role.company_admin': 'Company Admin',
  ...
  ar: {
    ...
    'home.hero.subtitle': 'اكتشف أحدث أجهزة الشبكات وتراخيص البرمجيات وخدمات التثبيت المهنية',
    'home.hero.cta': 'استكشف المنتجات',
    'home.features.title': 'لماذا تختار ستور هاب؟',
    'home.features.devices': 'أجهزة شبكات متميزة',
    'home.features.devices.desc': 'أحدث معدات الشبكات من أفضل العلامات التجارية',
